...
using variable variogram parameters
"""
    ...
    [
        (
            ...
            [
                ...
                lambda x, y: 1500.0 + 100.0 * x + 0.0 * y,
                lambda x, y: 500.0 + 0.0 * x + 50.0 * y,
                lambda x, y: 0.0 + 0.0 * x + 0.0 * y,
            ],
            2500,
        ...
        (
            ...
            [
                ...
                lambda x, y: 1500.0 + 100.0 * x + 0.0 * y,
                lambda x, y: 500.0 + 0.0 * x + 50.0 * y,
                lambda x, y: 0.0 + 0.0 * x + np.pi / 4 / 16.0 * y,
            ],
            2500,
...
def test_EllipseSimulation_VariableParms_FitRandomData(
    v, sdevLxLyTheta_func, size, outname
):
    """
    ...
    ans = seut.test_EllipseSimulation_NonStatFunc(
        v,
    ...
    actual_Lx = ans.Lx[4:-4, 4:-4]
    actual_Ly = ans.Ly[4:-4, 4:-4]
    actual_theta = ans.theta[4:-4, 4:-4]
    critical_val = 0.05
