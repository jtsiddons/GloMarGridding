...
@pytest.mark.parametrize(
    ...
    [
        (0.5, seut.cube_A_iris, 0.6, [1000, 1000, 0], 2500, "constant_1000_unrotated_0p5"),
        (1.5, seut.cube_A_iris, 0.6, [1000, 1000, 0], 2500, "constant_1000_unrotated_1p5"),
        (1.5, seut.cube_A_iris, 0.6, [1300, 1100, 0], 2500, "Lx1300_Ly1100_unrotated_1p5"),
        (1.5, seut.cube_A_iris, 0.6, [1300, 1100, np.pi/4], 2500, "Lx1300_Ly1100_45deg_1p5"),
        (1.5, seut.cube_A_iris, 0.6, [1500, 1000, 0], 2500, "Lx1500_Ly1000_unrotated_1p5"),
        (1.5, seut.cube_A_iris, 0.6, [1500, 1000, np.pi/4], 2500, "Lx1500_Ly1000_45deg_1p5"),
    ]
)
def test_EllipseSimulation_UniformParms_FitRandomData(v,
                                                      cube_template,
                                                      sdev,
                                                      sigma_parms,
                                                      size,
    ...
    ans = seut.test_EllipseSimulation_UniformParms(v, cube_template, sdev, sigma_parms)
    ...
    print('Check: Is this covariance constructed using fitted ellipse parameter consistent with the prescribed one?')
    ...
    W, p_val = se_og.chisq_test_using_likelihood_ratios_4_covariance(cov_hat, cov_og, size)
    ...
    # for Lx_hat_cubbie, Ly_hat_cubbie, theta_hat_cubbie in zipper:
    #     sigma_hat_parms = (Lx_hat_cubbie.data, Ly_hat_cubbie.data, theta_hat_cubbie.data)
    #     sigma_actual_parms = (sigma_parms[0], sigma_parms[1], sigma_parms[2])
