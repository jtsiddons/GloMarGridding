...
def main():
    ...
    for current_year in year_list:
        ...
        for current_month in month_list:
            ...
            print(monthly.index)
            # print(current_month)
            pentad_info_df = pd.DataFrame(
                {"pentad_index": monthly.index, "date": monthly}
            )

            obs_df = obs_qc_module.TAO_obs_main(
                data_path, year=current_year, month=current_month
            )
            print(obs_df)
            ...
            for timestep in monthly.index:
                ...
                try:
                    ...
                    metoffice_climatology = pentad_climatology[
                        "climatology"
                    ]  # [timestep]
                except KeyError:
                ...
                day_df = obs_qc_module.TAO_match_climatology_to_obs(
                ...
                obs_covariance, W = obs_module.TAO_measurement_covariance(
