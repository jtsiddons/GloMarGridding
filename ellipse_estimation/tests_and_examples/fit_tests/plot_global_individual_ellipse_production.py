...
def draw_ellipse(latlon_point, figlabel, mm, london_in_the_middle=True):
    ...
    ax.scatter(latlon[0]-360, latlon[1],
               ...
               color='black', 
               transform=ccrs.Geodetic())
    title = 'SST corr with x='+str(latlon_point[0])+' y='+str(latlon_point[1])+' \n'
    ...
    fig_name = fig_path+'/'+figlabel+'_'+str(mm).zfill(2)+'_global_corr_with_ellipse_correlation_contour.png'
    plt.savefig(fig_name)
    plt.clf() 
