...
from cube_covariance import sigma_rot_func
...
def as65_to_hs93_effective_range(L):
    '''
    Handcock-Stein 1993, Karspeck, and GSTAT (for common choices to v):
...
def ESA_landfrac(minimum_land_threshold=0.001,
    ...
    '''
    in_path = '/noc/mpoc/surface_data/ESA_CCI5deg_month_extra/ANOMALY/'
